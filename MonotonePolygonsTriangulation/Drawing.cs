...
namespace MonotonePolygonsTriangulation
{
    ...
    public partial class Form1
    {
        ...
        // void TriangulationPolygon()
        {
            ...
            {
                int tempX = polygonPoints.Find(p => p == minPointX).X - 1;
            ...
            if (isMonotone)
            {
                labelIsMonotone.Text = "Полигон монотонный с:";
                buttonTriangulation.Enabled = true;
            }
            else
            {
                labelIsMonotone.Text = "Полигон немонотонный :с";
                buttonTriangulation.Enabled = false;
            }
